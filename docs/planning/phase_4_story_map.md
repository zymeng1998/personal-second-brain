...
**Status (2026-06-10): REFINED — awaiting the open-decision review (OQ #21–#25).** No implementation
has started; stories promote to `Ready` only after the human confirms the open decisions below.
